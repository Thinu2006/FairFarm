...
<body class="bg-cover bg-center min-h-screen flex justify-center items-center px-4" 
    ...
    <div class="bg-white shadow-lg rounded-lg flex w-full max-w-4xl overflow-hidden">
        ...
        <div class="w-1/2 p-10">
            ...
            <form action="FarmerSignin.php" method="POST" class="form-container">
                <div>
            ...
            <p class="text-sm text-center mt-5">New to Fair Farm? <a href="http://localhost/FairFarm/app/views/Farmer/FarmerSignup.php" class="text-green-700 font-bold hover:text-green-800">Sign Up</a></p>
        </div>
    </div>
