...
<body class="bg-cover bg-opacity-90 bg-[#F5EFE6] bg-center flex items-center justify-center min-h-screen p-4" style="background-image: url('../../Images/BuyerLoginBG.jpg')";>
    <div class="bg-white border border-gray-300 shadow-2xl rounded-xl p-10 max-w-3xl w-full">
        <h1 class="text-4xl font-rowdies font-bold text-gray-800 mb-8 text-center">Add Paddy Type</h1>
        <form action="" method="post" enctype="multipart/form-data" class="space-y-6">
            <div>
                <label class="block text-lg font-bold text-gray-700 mb-2">Paddy Name</label>
                <input type="text" name="PaddyName" class="w-full p-2 border rounded bg-gray-100 focus:ring-2 focus:ring-green-400" required>
            </div>
            
            <div>
                <label class="block text-lg font-bold text-gray-700 mb-2">Maximum Price</label>
                <div class="flex items-center space-x-4">
                    <span class="text-gray-600">Rs.0</span>
                    <input type="range" id="Price" name="MaxPrice" max="1000" value="0" oninput="updatePrice()" class="w-full">
            ...
            <div>
                <label class="block text-lg font-bold text-gray-700 mb-2">Upload Image</label>
