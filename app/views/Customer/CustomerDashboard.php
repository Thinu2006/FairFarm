...
<body class="bg-green-50">
    ...
    <!-- Hero Section -->
<section class="relative w-full min-h-screen bg-cover bg-center flex items-center justify-center" style="background-image: url('./../../Images/bg2.jpg');">
    ...
    <section class="py-16 px-6 flex flex-col md:flex-row items-center">
        <img src="./../../Images/paddy.jpg" alt="Paddy" class="w-full md:w-1/3 rounded-lg shadow-md">
        <div class="md:ml-10 mt-6 md:mt-0">
        <h3 class="text-[#1F4529] text-2xl font-semibold">Paddy Of Sri Lanka</h3>
            <p class="text-gray-600 mt-4">Sri Lanka has a deep-rooted history in agriculture, particularly in paddy cultivation. The country's fertile lands and traditional farming techniques have resulted in some of the finest rice varieties in the world. From ancient irrigation systems to modern sustainable practices, paddy farming continues to be a key aspect of Sri Lanka’s economy and culture.</p>
            <p class="text-gray-600 mt-2">Farmers across the island dedicate their lives to producing high-quality rice that meets both local and international demands. The diversity of paddy types, including organic and heirloom varieties, showcases the rich agricultural heritage of the nation.</p>
        ...
        <!-- Products Section -->
        <section class="py-16 px-6 bg-[#E8DFCA]">
